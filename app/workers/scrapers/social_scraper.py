    ...
    def parse_rss(self, content):
        ...
        try:
            ...
            for entry in root.findall('atom:entry', namespaces):
                ...
                # edge case: some entries are subreddit homepages or user profiles with no relevant discussion content.
                ...
                articles.append({
                    ...
                    "title": title,
                    "content": raw_content if raw_content else title, # for now fallback to title if content is missing
                    "url": url,
