...
#=============================================
class ProxyManager:
    #proxies should be in format [{"server": "ip:port", "username": "user", "password": "pass"}, ...]
    def __init__(self, proxies=None):
        if proxies is None:
            proxies = []
        else: 
            assert isinstance(proxies, list), "Proxies should be a list of proxy configuration dicts"
    ...
    def get_proxy(self):
        ...
        return {
            ...
            "password": proxy.get("password"),  #optional, depends on proxy provider and setup
