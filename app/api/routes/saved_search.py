...
from app.schemas.saved_search_request import SavedSearchRequest
from app.schemas.saved_search_response import (
...
@router.post("/", response_model=SavedSearchResponseItem,
